...
* io: Migrate VCF functions from filter+utils to io [#929][] (@victorlin)
* Move AugurError to new errors.py, replace RuntimeError [#921][] (@victorlin)
* utils: Remove `read_metadata()` in favor of `io.read_metadata()` [#934][] (@victorlin)
* Remove `utils.myopen()`, add tests for `io.open_file()` [#926][] (@victorlin)
